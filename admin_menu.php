...
<head>
    ...
    <title>Manajemen Menu - Oak Coffee POS</title>
...
<body class="bg-brand-offwhite h-screen flex text-brand-black">
    ...
    <aside class="w-64 bg-brand-black text-white shadow-xl flex-hidden flex-col md:flex">
        ...
        <div class="p-6 flex flex-col gap-2 flex-1">
            ...
            <a href="admin_menu.php" class="px-4 py-3 bg-brand-red text-white rounded-xl font-medium transition-colors shadow-[0_4px_14px_rgba(230,57,70,0.4)] flex items-center gap-3"><i class="fa-solid fa-utensils w-5"></i> Manajemen Menu</a>
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex items-center gap-4">
                    <form action="" method="GET" class="relative">
                        <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>" placeholder="Cari menu atau kategori..." class="pl-10 pr-8 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:border-brand-red focus:ring-1 focus:ring-brand-red text-sm w-64">
                        <i class="fa-solid fa-magnifying-glass absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400"></i>
                        <?php if(!empty($search)): ?>
                            <a href="admin_menu.php" class="absolute right-3 top-1/2 -translate-y-1/2 text-brand-red hover:text-brand-darkred"><i class="fa-solid fa-xmark"></i></a>
                        <?php endif; ?>
                    </form>
